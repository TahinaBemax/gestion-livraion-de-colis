...
CREATE TABLE points_livraison(
   ...
   nom_point_livraison TEXT NOT NULL,
   nom_rue TEXT,
...
CREATE TABLE contraintes_livraison(
   ...
   heure_debut_livrable TIME NOT NULL,
   heure_fin_livrable TIME NOT NULL,
...
CREATE TABLE categories_livreur(
...
CREATE TABLE utilisateurs(
   ...
   FOREIGN KEY(id_type_utilisateur) REFERENCES types_utilisateur(id_type_utilisateur)
);
...
CREATE TABLE livreur_information(
   ...
   FOREIGN KEY(id_categorie_livreur) REFERENCES categories_livreur(id_categorie_livreur),
...
CREATE TABLE problemes_livraison(
   ...
   titre TEXT NOT NULL,
   description TEXT,
   date_heure_probleme_livraison TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
   id_livraison INTEGER NOT NULL,
...
CREATE TABLE problemes_colis(
   ...
   date_heure_probleme_colis TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
   id_colis INTEGER NOT NULL,
...
CREATE TABLE bordereaux_livraison(
   ...
   date_livraison DATE NOT NULL,
   date_scan_bordereau TIMESTAMP ,
   date_preuve_livraison TIMESTAMP,
...
CREATE TABLE notifications_recus(
   ...
   PRIMARY KEY(id_receveur, id_notification),
   FOREIGN KEY(id_receveur) REFERENCES utilisateurs(id_utilisateur),
...
CREATE TABLE contraintes_evenement(
   ...
   PRIMARY KEY(id_point_livraison, id_evenement),
   FOREIGN KEY(id_point_livraison) REFERENCES points_livraison(id_point_livraison),
